...
An end toend machine learning pipeline for predicting residential property sale prices, combining rich feature engineering, Optuna-tuned ensemble models, and a stacked meta-learner to achieve a competitive RMSE on log-transformed sale prices.
